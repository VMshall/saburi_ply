...
export function Navbar() {
  ...
  const currentLabel = routeNameByPath[location.pathname] ?? formatLabel(location.pathname);
                ...
                <div className="flex items-end space-x-4 xl:space-x-8">
                            ...
                            <div className="grid grid-cols-8 gap-4">
                              ...
                              <div>
                                ...
                                <ul className="space-y-3">
                                  <li>
                                    <Link
                                      to="/products/saburi-titanium-plus"
                                  ...
                                  <li>
                                    <Link
                                      to="/products/saburi-club-h-plus"
                                      className="text-sm font-semibold text-white/90 hover:text-red-500 hover:translate-x-2 transition-all duration-300 block py-1"
                                    >
                                      Saburi Club H+
                                    </Link>
                                  ...
                                  <li>
                                    <Link
                                      to="/products/marine-plywood-india"
                                      className="text-sm font-semibold text-white/90 hover:text-red-500 hover:translate-x-2 transition-all duration-300 block py-1"
                                    >
                                      Saburi Gold
                                    </Link>
                                  ...
                                  <li>
                                    <Link
                                      to="/products/fire-retardant-india"
                                      className="text-sm font-semibold text-white/90 hover:text-red-500 hover:translate-x-2 transition-all duration-300 block py-1"
                                    >
                                      Saburi FR
                                    </Link>
                                  ...
                                  <li>
                                    <Link
                                      to="/products/saburi-scout-plywood"
                                      className="text-sm font-semibold text-white/90 hover:text-red-500 hover:translate-x-2 transition-all duration-300 block py-1"
                                    >
                                      Saburi Scout
                                    </Link>
                                  ...
                                  <li>
                                    <Link
                                      to="/products/flexi-plywood-india"
                                      className="text-sm font-semibold text-white/90 hover:text-red-500 hover:translate-x-2 transition-all duration-300 block py-1"
                                    >
                                      Saburi Gold Flexi
                                    </Link>
                                  ...
                                  <li>
                                    <Link
                                      to="/products/shuttering-plywood-india"
                                      className="text-sm font-semibold text-white/90 hover:text-red-500 hover:translate-x-2 transition-all duration-300 block py-1"
                                    >
                              ...
                              <div>
                                ...
                                <ul className="space-y-3">
                                  <li>
                                    <Link
                                      to="/products/saburi-perennial-blockboard"
                                      className="text-sm font-semibold text-white/90 hover:text-red-500 hover:translate-x-2 transition-all duration-300 block py-1"
                                    >
                                  ...
                                  <li>
                                    <Link
                                      to="/products/saburi-fr-blockboard"
                                      className="text-sm font-semibold text-white/90 hover:text-red-500 hover:translate-x-2 transition-all duration-300 block py-1"
                                    >
                                  ...
                                  <li>
                                    <Link
                                      to="/products/saburi-gold-blockboard"
                                      className="text-sm font-semibold text-white/90 hover:text-red-500 hover:translate-x-2 transition-all duration-300 block py-1"
                                    >
                              ...
                              <div>
                                ...
                                <ul className="space-y-3">
                                  <li>
                                    <Link
                                      to="/products/saburi-smart-panel-wpc-board"
                                      className="text-sm font-semibold text-white/90 hover:text-red-500 hover:translate-x-2 transition-all duration-300 block py-1"
                                    >
                                  ...
                                  <li>
                                    <Link
                                      to="/products/saburi-smart-wpc-door-frame"
                                      className="text-sm font-semibold text-white/90 hover:text-red-500 hover:translate-x-2 transition-all duration-300 block py-1"
                                    >
                              ...
                              <div>
                                ...
                                <ul className="space-y-3">
                                  <li>
                                    <Link
                                      to="/products/saburi-modwud-pre-lam"
                                      className="text-sm font-semibold text-white/90 hover:text-red-500 hover:translate-x-2 transition-all duration-300 block py-1"
                                    >
                                  ...
                                  <li>
                                    <Link
                                      to="/products/saburi-modwud-plain"
                                      className="text-sm font-semibold text-white/90 hover:text-red-500 hover:translate-x-2 transition-all duration-300 block py-1"
                                    >
                                      Saburi Modwud Plain
                                    </Link>
                              ...
                              <div>
                                ...
                                <ul className="space-y-3">
                                  <li>
                                    <Link
                                      to="/products/saburi-hydramax-board"
                                      className="text-sm font-semibold text-white/90 hover:text-red-500 hover:translate-x-2 transition-all duration-300 block py-1"
                                    >
                  ...
                  >
                    <button
                      className={cn(
                        "px-3 py-2 text-sm font-medium transition-colors relative",
                        location.pathname.startsWith("/about") || showAboutMega
                          ? "text-primary after:absolute after:left-3 after:right-3 after:-bottom-0.5 after:h-0.5 after:bg-primary after:rounded-full"
                          : "text-black hover:text-primary hover:after:absolute hover:after:left-3 hover:after:right-3 hover:after:-bottom-0.5 hover:after:h-0.5 after:bg-primary/60 hover:after:rounded-full"
                      )}
                    >
                            ...
                            <div className="grid grid-cols-3 gap-16">
                              ...
                              <div>
                                ...
                                <ul className="space-y-3">
                                  ...
                                  <li>
                                    <Link
                                      to="/about/environment-stewardship"
                                      className="text-sm font-semibold text-white/90 hover:text-red-500 hover:translate-x-2 transition-all duration-300 block py-1"
                                    >
                  ...
                  <a href="https://saburiply.com/blog" className={navLinkClass({ isActive: location.pathname === "/blog" })}>
                    Blog
                  </a>
      ...
      {isOpen && (
        <div className="lg:hidden max-h-[calc(100vh-80px)] overflow-y-auto">
          <div className="px-3 pt-2 pb-3 space-y-1 sm:px-4 bg-white shadow-lg border-t border-gray-200">
            ...
            <NavLink
              to="/"
              className={({ isActive }) => cn("block px-3 py-2 text-base font-semibold tracking-wide transition-colors", isActive ? "text-primary" : "text-black hover:text-primary")}
              onClick={toggleMenu}
              end
            >
              Home
            ...
            {mobileAboutOpen && (
              <div className="pl-6 space-y-1">
                <Link to="/about" className="block py-2 text-sm text-black hover:text-primary" onClick={toggleMenu}>
                  • Company Overview
                </Link>
                <Link to="/about/accreditation" className="block py-2 text-sm text-black hover:text-primary" onClick={toggleMenu}>
                  • Accreditation
                </Link>
                <Link to="/about/national-presence" className="block py-2 text-sm text-black hover:text-primary" onClick={toggleMenu}>
                  • Our National Presence
                </Link>
                <Link to="/about/environment-stewardship" className="block py-2 text-sm text-black hover:text-primary" onClick={toggleMenu}>
                  • Environment Stewardship
                </Link>
                <Link to="/about/privacy-policy" className="block py-2 text-sm text-black hover:text-primary" onClick={toggleMenu}>
                  • Privacy Policy
                </Link>
              </div>
            )}
