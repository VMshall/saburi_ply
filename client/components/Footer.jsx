...
import { MapPin, Phone, Mail, Clock, Facebook, Youtube, Linkedin, Instagram, ArrowUp, MessageCircle, X, FileText, PaintBucket, Building2 } from "lucide-react";
...
const DealershipDialog = lazy(() => import("./DealershipDialog").then(m => ({ default: m.DealershipDialog })));
const MobileQuoteForm = lazy(() => import("./MobileQuoteForm").then(m => ({ default: m.MobileQuoteForm })));
const InteriorDesignerDialog = lazy(() => import("./InteriorDesignerDialog").then(m => ({ default: m.InteriorDesignerDialog })));
const ArchitectDialog = lazy(() => import("./ArchitectDialog").then(m => ({ default: m.ArchitectDialog })));
...
export function Footer() {
  ...
  const whatsAppWrapperRef = useRef(null);
  ...
  const handleNewsletterSubscribe = async (e) => {
    ...
    try {
      const response = await fetch(`${API_CONFIG.ADMIN_BASE_URL}${API_CONFIG.ENDPOINTS.SUBSCRIBER}`, {
        method: 'POST',
        headers: {
  ...
  const fetchSitemap = async () => {
    try {
      ...
      const currentDomain = window.location.origin;
      setSitemapUrls([{ full: `${currentDomain}/sitemap.xml`, relative: '/sitemap.xml', displayPath: '/sitemap.xml', isExternal: true }]);
      setCurrentSitemapUrl(`${currentDomain}/sitemap.xml`);
    }
  };
  ...
  const businessLinks = [
    ...
    // { name: "Bulk Pricing", href: "#contact" },
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="mt-8">
                ...
                <div className="space-y-2 text-xs text-gray-400">
                  <a
                    href="/footer-certificate/CARB_certification.pdf"
                    target="_blank"
                  ...
                  <a
                    href="/footer-certificate/CE_certification.pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block text-gray-300 hover:text-primary transition-colors text-sm"
                  >
                  ...
                  <a
                    href="/footer-certificate/IGBC_Certification.pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block text-gray-300 hover:text-primary transition-colors text-sm"
                  >
                  ...
                  <a
                    href="/footer-certificate/FSC_certification.pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block text-gray-300 hover:text-primary transition-colors text-sm"
                  >
                  ...
                  <a
                    href="/footer-certificate/ISO_90012015_Certified.pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block text-gray-300 hover:text-primary transition-colors text-sm"
                  >
            ...
            <div>
              ...
              <div className="mt-8">
                ...
                <Link to="/about/national-presence" className="text-gray-300 hover:text-primary transition-colors text-sm">
