...
export default function FireRetardant() {
  const images = [
    {
      id: 1,
      src: "/images/plywood-product/Saburi FR.webp",
      alt: "Saburi Fire Retardant board",
    },
  ];
  ...
  const badges = [
    { id: "spark", icon: GiLaserSparks, title: "Lesser Spark Tendency", sub: "Available" },
    { id: "burning", icon: Flame, title: "Slow Burning", sub: "Available" },
  ...
  const scrollToDetails = () => {
    const el = document.getElementById("fireretardant-details");
  ...
  const faqs = [
    {
      question: "How does Saburi Fire Retardant Plywood work in the event of a fire?",
      answer: "This plywood is treated with advanced, specialized fire-retardant chemicals. In the event of a fire, these chemicals delay the ignition of the wood, slow down the rate of flame spread, and restrict the penetration of the fire."
    },
    {
      question: "Where is it most important to install Fire Retardant plywood?",
      answer: "It is highly recommended for high-risk and high-value areas such as commercial kitchens, electrical rooms, server rooms, public auditoriums, hospitals, and exit corridors where fire safety is a top priority."
    },
    {
      question: "Does this plywood emit toxic smoke if it catches fire?",
      answer: "No. Saburi Fire Retardant plywood is engineered with E-Zero emission technology, ensuring extremely low formaldehyde release. It also produces minimal smoke and reduces toxic gas emission during fire, enhancing indoor air safety and supporting safer evacuation in emergency situations."
    },
    {
      question: "Is the strength of the plywood compromised by the fire-retardant chemical treatment?",
      answer: "Not at all. The chemical impregnation process is carefully calibrated to ensure that the plywood retains all its structural strength, durability, and load-bearing capacities alongside its fire-resistant properties."
    },
    {
      question: "Can I apply laminates or veneers over Saburi Fire Retardant plywood?",
      answer: "Yes. The surface is calibrated and sanded to a smooth finish, allowing for easy application of laminates, veneers, or paint without affecting the underlying fire-retardant properties."
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <PageHeader title="Saburi Fire Retardant" trail={[{ name: "Home", to: "/" }, { name: "Products" }]} />

      <section className="py-8 sm:py-12 lg:py-16">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative">
          <div className="text-center mb-8 lg:mb-12">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary tracking-wide">SABURI FIRE RETARDANT</h1>
            {/* <div className="mt-3 flex items-center justify-center gap-2">
              <span className="px-3 py-1 text-xs rounded-full border border-primary/20 bg-primary/5 text-primary">IS: 5509</span>
            ...
            <div className="bg-white rounded-xl shadow-[0_10px_30px_rgba(2,6,23,0.06)] ring-1 ring-gray-100 p-6 relative" style={{ height: rightCardHeight || undefined }}>
              <div className="flex h-full flex-col">
                ...
                {/* <div className="flex flex-wrap gap-2 mb-4">
                  <span className="px-3 py-1 text-xs rounded-full border bg-white text-gray-700">FIRE RESISTANT</span>
                </div> */}

                {/* brand block */}
                <div className="mb-2">
                  <div className="inline-flex items-baseline gap-3">
                    <h2 className="text-2xl font-semibold tracking-wide bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">Saburi FR (IS: 5509)</h2>
                    {/* <span className="text-[10px] uppercase tracking-widest px-2 py-0.5 rounded-full bg-gray-100 text-gray-600">Certified Safe</span> */}
                  </div>
                </div>
                ...
                <div className="flex-1 flex flex-col min-h-0">
                  <div role="tablist" aria-label="Fire Retardant details" className="inline-flex flex-wrap rounded-lg border p-1 bg-gray-50 gap-1">
