...
export default function SaburiModwudPreLaminated() {
  const images = [
    {
      id: 1,
      src: "/images/chipboard-product/Saburi-Modwud-Pre-Laminated-.webp",
      alt: "Saburi Perennial board full view",
    },
    {
      id: 2,
      src: "/images/chipboard-product/Saburi-Modwud-Pre-Lam 2.webp",
...
`;
  ...
  const faqs = [
    {
      question: "What is Saburi Modwud Pre-Lam Chipboard?",
      answer: "Saburi Modwud Pre-Lam Chipboard is an engineered wood panel made from compressed wood particles bonded under high pressure. It is factory pre-laminated with high-quality decorative laminates, providing a smooth, durable, and ready-to-use surface for modern furniture and interior applications."
    },
    {
      question: "Do I need to buy and apply laminates separately for this board?",
      answer: "No, Saburi Modwud Pre-Lam Chipboard is factory-pressed with Pure MF impregnated decorative paper, offering fade-resistant surfaces. This ready-to-use finish eliminates on-site lamination, saving labour, adhesive costs, and installation time while ensuring consistent quality and durability."
    },
    {
      question: "Is the pre-laminated surface resistant to daily wear and tear?",
      answer: "Yes. The melamine surface is highly durable and designed to resist scratches, stains, and mild heat. It is incredibly easy to maintain and can be wiped clean with a damp cloth, making it perfect for everyday use."
    },
    {
      question: "How does Saburi Modwud Pre-Lam help in speeding up project delivery?",
      answer: "Because the board is ready-to-use straight from the factory, carpenters and OEM furniture makers simply need to cut it to size, apply edge-banding, and assemble using standard joinery fittings like minifix cams. This drastically reduces production turnaround time."
    },
    {
      question: "Does Saburi Modwud Pre-Lam Chipboard have good screw holding strength?",
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <PageHeader title="Saburi Modwud Pre-Laminated" trail={[{ name: "Home", to: "/" }, { name: "Products" }]} />

      <section className="py-8 sm:py-12 lg:py-16">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative">
          <div className="text-center mb-8 lg:mb-12">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary tracking-wide">SABURI MODWUD PRE-LAM</h1>
            {/* <div className="mt-3 flex items-center justify-center gap-2">
              <span className="px-3 py-1 text-xs rounded-full border border-primary/20 bg-primary/5 text-primary">IS: 12823</span>
              ...
              <div className="flex h-full flex-col">
                ...
                <div className="mb-2">
                  <div className="inline-flex items-baseline gap-3">
                    <h2 className="text-2xl font-semibold tracking-wide bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">Saburi Modwud Pre-Lam (IS: 12823)</h2>
