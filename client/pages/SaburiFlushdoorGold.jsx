...
export default function SaburiFlushdoorGold() {
    const images = [
        {
            id: 1,
            src: "/images/flushdoor-product/Gold Flush Door 1.webp",
            alt: "Saburi Flushdoor Gold full view",
        },
        {
            id: 2,
            src: "/images/flushdoor-product/Gold Flush Door 2.webp",
            alt: "Saburi Flushdoor Gold – details and markings",
        },
    ];
    ...
    const premium = `Saburi Flushdoor Gold is manufactured to IS: 2202 standards, ensuring consistent strength, 
dimensional accuracy, and long-term performance across both residential and commercial 
applications. Each door is built to withstand everyday wear whilst retaining its finish and 
structural integrity over time.
As a trusted <strong>Flush Door Manufacturer in India</strong>, Saburi Ply offers a wide range of designs 
suitable for homes, offices, and commercial spaces alike. Whether the requirement is functional 
or decorative, Saburi Ply remains the dependable Manufacturer for those who expect quality, 
reliability, and style in equal measure.`;
    ...
    const faqs = [
        {
            question: "What makes Saburi Flushdoor Gold suitable for both interior and exterior use?",
            answer: "Saburi Flushdoor Gold is manufactured using 100% kiln-dried (KD) Pinewood solid core, bonded with premium BWP (Boiling Water Proof) grade resins. This strong construction ensures high durability, stability, and resistance to impact, making it ideal for both interior rooms and exterior entrance doors."
        },
        {
            question: "Does the Saburi Gold Flush Door come in a large 10 ft × 4 ft size?",
            answer: "Yes. Saburi Gold Flush Door is available in a large 10 ft × 4 ft size, making it ideal for grand entrances, commercial spaces, and premium interiors while maintaining excellent strength, stability, and superior finish."
        },
        {
            question: "Will the door hold heavy security locks and modern hinges securely?",
            answer: "Absolutely. The core of Saburi Flushdoor Gold is tightly packed with zero gaps, providing superior screw-holding capacity. This ensures that heavy-duty hinges, mortise locks, deadbolts, and smart security hardware remain firmly anchored for decades without loosening. As a trusted <strong>Flush Door Manufacturer in India</strong>, Saburi Ply engineers every door to meet this standard consistently."
        },
        {
            question: "Is the wood inside the door protected against pest attacks?",
            answer: "Yes. The timber used in our flush doors undergoes a rigorous vacuum-pressure impregnation process using advanced, eco-friendly chemical preservatives. This renders the door completely immune to termites, wood borers, and fungal decay."
        },
        {
            question: "What kind of decorative finishes can I apply to Saburi Flushdoor Gold?",
            answer: "The door is manufactured with a highly calibrated, perfectly smooth surface. This provides an ideal, flawless base for pressing decorative laminates, applying premium natural veneers, or finishing with high-quality paints and polishes to match your interior design. Saburi Ply, a leading <strong>Flush Door Manufacturer in India</strong>, maintains this surface quality consistently across its entire flush door range."
        },
    ];
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <PageHeader title="Flush Door Manufacturer in India" trail={[{ name: "Home", to: "/" }, { name: "Products" }]} />

            <section className="py-8 sm:py-12 lg:py-16">
                <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative">
                    <div className="text-center mb-8 lg:mb-12">
                        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary tracking-wide">FLUSH DOOR MANUFACTURER IN INDIA</h1>
                        {/* <div className="mt-3 flex items-center justify-center gap-2">
                            <span className="px-3 py-1 text-xs rounded-full border border-primary/20 bg-primary/5 text-primary">IS: 2202</span>
                            ...
                            <div className="flex h-full flex-col">
                                ...
                                <div className="mb-2">
                                    <div className="inline-flex items-baseline gap-3">
                                        <h2 className="text-2xl font-semibold tracking-wide bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">Saburi Flushdoor Gold (IS: 2202)</h2>
                                        {/* <span className="text-[10px] uppercase tracking-widest px-2 py-0.5 rounded-full bg-gray-100 text-gray-600">Premium & Durable</span> */}
                                    </div>
                                </div>
                                ...
                                <div className="flex-1 flex flex-col min-h-0">
                                    <div role="tablist" aria-label="Flushdoor details" className="inline-flex flex-wrap rounded-lg border p-1 bg-gray-50 gap-1">
                ...
                <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
                    <div className="text-center mb-8 lg:mb-12">
                        ...
                        <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
                            Find answers to common questions about Saburi Flushdoor Gold plywood
                        </p>
                    </div>
