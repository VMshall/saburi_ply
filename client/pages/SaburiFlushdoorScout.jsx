...
import { GiChemicalDrop, GiDiamondHard } from "react-icons/gi";
import {
    ArrowLeft,
    ArrowRight,
    QrCode,
...
export default function SaburiFlushdoorScout() {
    const images = [
        {
            id: 1,
            src: "/images/flushdoor-product/SCOUT Flush Door.webp",
            alt: "Saburi Perennial board full view",
        },
        {
            id: 2,
            src: "/images/flushdoor-product/SCOUT Flush Door 2.webp",
    ...
    const badges = [
        { id: "chemical", icon: GiChemicalDrop, title: "Chemical Treatment", sub: "High" },
        { id: "hardwood", icon: GiDiamondHard, title: "Hardwood Battens", sub: "Available" },
        { id: "insect", icon: FaBacteria, title: "Insect Resistance", sub: "High" },
    ];
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <PageHeader title="Saburi Flushdoor Scout" trail={[{ name: "Home", to: "/" }, { name: "Products" }]} />

            <section className="py-8 sm:py-12 lg:py-16">
                <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative">
                    <div className="text-center mb-8 lg:mb-12">
                        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary tracking-wide">SABURI FLUSHDOOR SCOUT</h1>
                            ...
                            <div className="flex h-full flex-col">
                                ...
                                <div className="mb-2">
                                    <div className="inline-flex items-baseline gap-3">
                                        <h2 className="text-2xl font-semibold tracking-wide bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">Saburi Flush Door Scout (IS: 2202)</h2>
