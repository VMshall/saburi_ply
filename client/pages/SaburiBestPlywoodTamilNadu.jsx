...
export default function SaburiBestPlywoodTamilNadu() {
    const images = [
        {
            id: 1,
            src: "/images/south-region-plywoods/Bangalore 1.webp",
            alt: "Saburi Best Plywood TamilNadu board full view",
        },
    ];
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <PageHeader title="Best Plywood Tamil Nadu" trail={[{ name: "Home", to: "/" }, { name: "Products" }]} />

            <section className="py-8 sm:py-12 lg:py-16">
                <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative">
                    <div className="text-center mb-8 lg:mb-12">
                        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary tracking-wide">Plywood Manufacturer & Supplier Tamil Nadu</h1>
                            ...
                            <div className="flex h-full flex-col">
                                ...
                                <div className="mb-2">
                                    <div className="inline-flex items-baseline gap-3">
                                        <h2 className="text-2xl font-semibold tracking-wide bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">Top Quality Plywood in Tamil Nadu - <br />Your Trusted Manufacturer and Supplier</h2>
                                ...
                                <div className="mt-2">
                                    ...
                                    <p className="mb-2">Seeking the best plywood manufacturer and supplier in Tamil Nadu? Saburi Ply proudly brings high-quality plywood to the market, with products catering to diverse needs across the region. Being one of the leading plywood brands in Chennai, we cater to a wide range of clients with products which assure durability, aesthetics, and eco-friendliness.</p>
                                    <p className="mb-2">We are one of the leading plywood manufacturers in Chennai and one of the top-grade plywood manufacturers in TamilNadu. We provide various kinds and grades of plywood with competitive prices. We are focused on delivering perfect products for furniture, interiors, and construction projects to customers.</p>
                                    <p className="mb-2">We ensure our products meet international standards, making us the choice of preference. Be it attaining one of the best plywood brands in Chennai to Coimbatore or lowest plywood price in TamilNadu, we deliver excellence right at your doorstep.</p>
                                    <p className="mb-2">Find plywood products of different varieties available from renowned plywood manufacturers in TamilNadu, in the key cities of Chennai and Coimbatore. It's time to rely on us: Low price, Quality, and On-Time delivery. We are your prime choice for all your plywood requirements in Tamil Nadu, and you will see the difference in every - board.</p>
                                    <p className="text-primary font-semibold mb-2">Best Plywood Brands in Chennai – Your Reliable Partner</p>
                                    <ul>
                                        <li>● Esteemed plywood manufacturers in Chennai, Tamil Nadu supply superior plywood designed to meet the needs of construction, interior spaces, and furniture projects.</li>
                                        <li>● Acknowledged as a top plywood supplier in Coimbatore, we guarantee that each product is both environmentally friendly and durable.</li>
                                        <li>● With our attractive pricing and dependable on-time delivery, we have become the leading plywood supplier in Tamil Nadu.</li>
                                    </ul>
                                </div>
