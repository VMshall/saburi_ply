...
export default function SaburiClubHPlusBlockBoard() {
    const images = [
        {
            id: 1,
    ...
    const premium = `Saburi CLUB H+ is built for projects where strength, precision, and longevity are non-negotiable. Manufactured from 100% selected hardwood timber and IS: 1659 certified, each 
board is kiln-seasoned to 8-10% moisture content and treated with preservatives against 
termites, fungus, and borers. It offers excellent screw-holding capacity with no warping, 
expansion, or contraction over time.
As a trusted <strong>Block Board Manufacturer</strong> in India, Saburi Ply produces boards that perform 
reliably across premium furniture and exterior applications. Recognised nationally, Saburi CLUB 
H+ is the dependable choice for those who will not compromise on finish or durability.`;
    ...
    const badges = [
        { id: "deep", icon: FaBacteria, title: "Deep Preservative", sub: "High" },
        { id: "hardwood", icon: GiDiamondHard, title: "Hardwood", sub: "Available" },
        { id: "strength", icon: Dumbbell, title: "High Load Bearing", sub: "High" },
        { id: "balance", icon: Scale, title: "Dimensional Stability", sub: "Available" },
    ...
    const faqs = [
        {
            question: "What positions Saburi Club H+ as a premium blockboard choice?",
            answer: "As a leading <strong>Block Board Manufacturer</strong> in India, Saburi designs heavy-duty film-faced densified plywood specifically for concrete formwork, construction shuttering, and scaffolding. It is used to cast smooth concrete walls, slabs, and columns"
        },
        {
            question: "Can Saburi Club H+ withstand seasonal moisture changes?",
            answer: "Yes. It features excellent moisture-resistant properties, making it incredibly stable across changing seasons. It won't expand, contract, or warp during the heavy monsoon or dry winters."
        },
        {
            question: "Is the core of the Club H+ blockboard free of gaps?",
            answer: "Yes, we utilize a zero-gap core construction method. The wooden battens are precision-cut and seamlessly edge-glued, ensuring there are no hidden hollow spaces. This provides uniform strength across the entire board."
        },
        {
            question: "What kind of finish can I expect when cutting or routing this board?",
            answer: "Because of the premium face veneers and solid core, carpenters will experience smooth, clean cuts with zero splintering. This makes it ideal for highly detailed, custom woodwork and flawless edge-banding."
        },
        {
            question: "What kind of pest protection does Club H+ offer?",
            answer: "It undergoes a multi-stage, deep-penetration chemical treatment that renders it completely immune to termites and wood borers, ensuring your premium furniture investments are protected for decades."
        },
    ];
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <PageHeader title="Block Board Manufacturer in India" trail={[{ name: "Home", to: "/" }, { name: "Products" }]} />

            <section className="py-8 sm:py-12 lg:py-16">
                <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative">
                    <div className="text-center mb-8 lg:mb-12">
                        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary tracking-wide">BLOCK BOARD MANUFACTURER IN INDIA</h1>
                            ...
                            <div className="flex h-full flex-col">
                                ...
                                <div className="mb-2">
                                    <div className="inline-flex items-baseline gap-3">
                                        <h2 className="text-2xl font-semibold tracking-wide bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">Saburi CLUB H+ Block Board (IS: 1659)</h2>
                ...
                <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
                    <div className="text-center mb-8 lg:mb-12">
                        ...
                        <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
                            Find answers to common questions about Saburi CLUB H+ Block Board
                        </p>
                    </div>
