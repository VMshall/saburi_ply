...
export default function SaburiPerennial() {
  const images = [
    {
      id: 1,
      src: "/placeholder.svg",
  ...
  const premium = `Manufactured from best quality Burma Gurjan hardwood; bonded with Phenol Formaldehyde resin and subjected to permanent preservative treatment by vacuum impregnation. Resistant to fire, marine grade, and can withstand saline water.`;
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <PageHeader title="Saburi Perennial" trail={[{name:"Home", to:"/"},{name:"Products"}]} />

      <section className="py-8 sm:py-12 lg:py-16">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative">
          <div className="text-center mb-8 lg:mb-12">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary tracking-wide">SABURI PERENNIAL</h1>
            ...
            <div className="bg-white rounded-xl shadow-[0_10px_30px_rgba(2,6,23,0.06)] ring-1 ring-gray-100 p-6 relative" style={{ height: rightCardHeight || undefined }}>
              ...
              <div className="mb-2">
                <div className="inline-flex items-baseline gap-3">
                  <h2 className="text-2xl font-semibold tracking-wide bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">Saburi Perennial (IS: 10701)</h2>
                ...
                <div role="tablist" aria-label="Perennial details" className="inline-flex rounded-lg border p-1 bg-gray-50">
                  <button
                    ...
                    className={`px-3 py-1 text-xs rounded-md transition-colors ${
                      activeTab === "features" ? "bg-white text-gray-900 shadow-sm" : "text-gray-600 hover:text-gray-900"
                    }`}
                  >
                    Unique Features
                  </button>
