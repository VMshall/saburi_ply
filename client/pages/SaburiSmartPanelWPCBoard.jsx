...
export default function SaburiSmartPanelWPCBoard() {
    const images = [
        {
            id: 1,
            src: "/images/wpcpvc-product/wpc-door/Endura.webp",
    ...
    const badges = [
        { id: "eco-friendly", icon: IoLeafOutline, title: "Eco-Friendly", sub: "Available" },
        { id: "paint", icon: LuPaintBucket, title: "Paint Ready", sub: "Available" },
        { id: "strength", icon: Dumbbell, title: "High Impact Strength", sub: "High" },
    ...
    const faqs = [
        {
            ...
            answer: "WPC stands for Wood Plastic Composite. It is an advanced, eco-friendly material made from a blend of wood fibers and thermoplastics. Saburi Smart Panels are incredibly versatile and are the ultimate choice for moisture-heavy areas like modular kitchens, bathroom vanities, swimming pool decking, and exterior wall cladding."
        },
        {
            question: "Is the Saburi Smart Panel 100% waterproof and termite-proof?",
            answer: "Yes, absolutely. Because of its thermoplastic polymer composition, the board is entirely impervious to water, meaning it will never rot, swell, or delaminate. Additionally, it is naturally immune to termites, borers, and fungus without the need for toxic chemical treatments."
        },
        {
            question: "How does it compare to traditional plywood in terms of fire safety?",
            answer: "Saburi Smart Panel WPC Boards are inherently fire-retardant. Unlike standard wood that acts as fuel, WPC materials self-extinguish when the flame source is removed and do not emit toxic smoke, making them a much safer alternative for residential and commercial interiors."
        },
        {
            question: "Can I apply paint, laminates, or veneers directly to the WPC surface?",
            answer: "Yes. The boards come with a perfectly smooth, calibrated surface that is ready to use. You can easily apply high-gloss acrylics, PVC laminates, natural wood veneers, or premium PU paints to match any interior design scheme."
        },
        {
            question: "Do carpenters need special tools to work with Saburi WPC boards?",
            answer: "No special equipment is required. Saburi Smart Panels can be cut, drilled, routed, and nailed using standard commercial woodworking tools. The high-density core also ensures excellent screw-holding capacity for hinges and cabinet hardware."
        },
    ];
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <PageHeader title="Best Smart Panels Manufacturer in India" trail={[{ name: "Home", to: "/" }, { name: "Products" }]} />

            <section className="py-8 sm:py-12 lg:py-16">
                <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative">
                    <div className="text-center mb-8 lg:mb-12">
                        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary tracking-wide">BEST SMART PANELS MANUFACTURER IN INDIA</h1>
                        {/* <div className="mt-3 flex items-center justify-center gap-2">
                            <span className="px-3 py-1 text-xs rounded-full border border-primary/20 bg-primary/5 text-primary">Endura Ace</span>
                            <span className="px-3 py-1 text-xs rounded-full border border-primary/20 bg-primary/5 text-primary">Club / Pro</span>
                        </div> */}
                            ...
                            <div className="flex h-full flex-col">
                                ...
                                <div className="mb-2">
                                    <div className="inline-flex items-baseline gap-3">
                                        <h2 className="text-2xl font-semibold tracking-wide bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">Saburi Smart Panels – WPC Boards (Endura Ace / Club / Pro)</h2>
