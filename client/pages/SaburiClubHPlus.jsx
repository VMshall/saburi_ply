...
export default function SaburiClubHPlus() {
  const images = [
    {
      id: 1,
  ...
  const premium = `Surety for furniture, a premium for life. Saburi Club H+ delivers reliable performance with anti‑bacterial properties and stringent E0 emission compliance. Backed by a Lifetime Warranty and engineered for fire resistance, it is a trusted choice for homes and offices.`;
  ...
  const badges = [
    { id: "waterproof", icon: Droplets, title: "Boiling Water Resistant", sub: "Available" },
    // { id: "boiling", icon: Flame, title: "Fire Resistant", sub: "Available" },
  ...
  const scrollToDetails = () => {
    const el = document.getElementById("clubhplus-details");
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <PageHeader title="Saburi Club H+" trail={[{ name: "Home", to: "/" }, { name: "Products" }]} />

      <section className="py-8 sm:py-12 lg:py-16">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative">
          <div className="text-center mb-8 lg:mb-12">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary tracking-wide">SABURI CLUB H+</h1>
              ...
              <div className="flex h-full flex-col">
                ...
                <div className="mb-2">
                  <div className="inline-flex items-baseline gap-3">
                    <h2 className="text-2xl font-semibold tracking-wide bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">Saburi Club H+ (IS: 10701)</h2>
                    {/* <span className="text-[10px] uppercase tracking-widest px-2 py-0.5 rounded-full bg-gray-100 text-gray-600">CML NO.5500122897</span> */}
                  </div>
                </div>
                ...
                <div className="flex-1 flex flex-col min-h-0">
                  <div role="tablist" aria-label="Club H+ details" className="inline-flex flex-wrap rounded-lg border p-1 bg-gray-50 gap-1">
