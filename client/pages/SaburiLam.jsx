...
export default function SaburiLam() {
    const images = [
        {
            id: 1,
            src: "/images/lamination-product/6.webp",
            alt: "Saburi Perennial board full view",
        },
        {
            id: 2,
            src: "/images/lamination-product/7.webp",
            alt: "Saburi Perennial – details and markings",
        },
        {
            id: 3,
            src: "/images/lamination-product/8.webp",
            alt: "Saburi Perennial – details and markings",
        },
    ];
    ...
    const premium = `Saburi Lam brings a fresh pulse to modern interiors with liners crafted for designers who refuse to settle for ordinary. Built on advanced technology and deep material expertise, Saburi Lam stands as a leading brand trusted for premium quality, durability, and timeless design. Our collection unfolds in three expressive moods.`;
    ...
    const badges = [
        { id: "scratch", icon: GiTripleScratches, title: "Scratch Resistance", sub: "Available" },
        { id: "texture", icon: TbTexture, title: "Rich Texture", sub: "Rich" },
        { id: "color", icon: IoColorPaletteOutline, title: "Faded Color Resistant", sub: "Resistant" },
        { id: "strength", icon: Dumbbell, title: "Strength", sub: "Long Lasting" },
    ];
    ...
    const faqs = [
        {
            question: "What is Saburi Lam and where is it used?",
            answer: "Saburi Lam is a high-quality liner used for furniture lamination and veneer applications. It enhances the surface finish of plywood, particle boards, and MDF, making it ideal for wardrobes, cabinets, modular furniture, and interior paneling."
        },
        {
            question: "What design collections are available in Saburi Lam?",
            answer: "Saburi Lam is available in three stylish collections – Fabric Collection, Wooden Collection, and Plain Collection, offering versatile design options to match modern, classic, and minimal interior furniture styles."
        },
        {
            question: "What thickness options are available in Saburi Lam?",
            answer: "Saburi Lam is available in 0.72 mm, 0.82 mm, and 0.9 mm thickness, providing flexibility to choose the right liner based on durability, finish quality, and furniture application requirements."
        },
        {
            question: "Why should furniture manufacturers choose Saburi Lam?",
            answer: "Saburi Lam provides consistent finish, attractive designs, and reliable durability. It helps furniture manufacturers achieve a premium look while ensuring smooth lamination over plywood, MDF, and particle boards."
        },
        {
            question: "What are the main advantages of using Saburi Lam in furniture?",
            answer: "Saburi Lam improves furniture aesthetics, offers uniform texture, supports easy lamination, provides multiple design choices, and ensures a durable surface finish suitable for modular and residential furniture applications."
        },
    ];
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <PageHeader title="Saburi Liner" trail={[{ name: "Home", to: "/" }, { name: "Products" }]} />

            <section className="py-8 sm:py-12 lg:py-16">
                <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative">
                    <div className="text-center mb-8 lg:mb-12">
                        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary tracking-wide">SABURI LAM</h1>
                            ...
                            <div className="flex h-full flex-col">
                                ...
                                <div className="mb-2">
                                    <div className="inline-flex items-baseline gap-3">
                                        <h2 className="text-2xl font-semibold tracking-wide bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">Saburi Lam – Designer Laminates Collection</h2>
