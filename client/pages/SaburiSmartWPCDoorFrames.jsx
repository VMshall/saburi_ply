...
export default function SaburiSmartWPCDoorFrames() {
    const images = [
        {
            id: 1,
            src: "/images/wpcpvc-product/wpc-door/WPC-Doors.webp",
            alt: "Saburi Perennial – details and markings",
        },
        {
            id: 2,
            src: "/images/wpcpvc-product/wpc-door/aburi-Smart-WPC-Door-Frames.webp",
    ...
    const premium = `Saburi Smart WPC Door Frames are built for strength, moisture resistance, and long-term 
    stability. Manufactured using BWP grade WPC material, they are completely immune to 
    termites, borers, rot, and water damage. Unlike traditional wooden frames, they will not crack, 
    warp, or swell under any weather condition.
    The smooth, uniform finish ensures straightforward installation and lasting aesthetic appeal 
    across modern homes, commercial spaces, and moisture-prone environments. As a recognised 
    <strong>Best Door Frame Manufacturer in India</strong>, Saburi Ply backs every frame with a Lifetime 
    Warranty.`;
    ...
    const badges = [
        ...
        { id: "strength", icon: Dumbbell, title: "Structural Strength", sub: "High" },
    ...
    const faqs = [
        {
            question: "Why should I choose Saburi Smart WPC Door Frames over traditional wooden frames?",
            answer: "Traditional wooden frames are highly prone to rotting from ground moisture and serve as the primary entry point for termites. As the <strong>Best Door Frame Manufacturer in India</strong>, Saburi provides WPC frames that eliminate these risks entirely. They are <strong>100% waterproof, termite-proof,</strong> and designed to last a lifetime without decaying or warping."
        },
        {
            question: "Do WPC door frames swell or shrink during the monsoon season?",
            answer: "No. One of the biggest advantages of Saburi WPC frames is their absolute <strong>dimensional stability</strong>. Because they do not absorb atmospheric moisture, you will never experience doors jamming during the rainy season or gaps appearing during the dry winter."
        },
        {
            question: "Are Saburi WPC Doors & Door Frames available in different sizes and thicknesses?",
        ...
        {
            question: "Are Saburi WPC Doors available in different design finishes?",
            answer: "Yes. Saburi WPC Doors are designed to match any interior style. Customers can choose from: <strong>Digital Print Doors</strong> for vibrant, modern looks. <strong>Routed Digital Doors</strong> for combining texture with high-end printing. <strong>Fully Routed Designer Doors</strong> for a premium, sculpted aesthetic. These options offer the perfect blend of high-end aesthetics and rugged durability."
        },
        {
            question: "Can the frames be finished to match the look of a wooden door?",
            answer: "Absolutely. While they come in a <strong>ready-to-use premium finish</strong>, Saburi WPC Door Frames can be easily painted, polished, or wrapped with PVC decorative foils to perfectly match the color and texture of your doors and existing interior decor."
        },
    ];
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <PageHeader title="Best Door Frame Manufacturer in India" trail={[{ name: "Home", to: "/" }, { name: "Products" }]} />

            <section className="py-8 sm:py-12 lg:py-16">
                <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative">
                    <div className="text-center mb-8 lg:mb-12">
                        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary tracking-wide">BEST DOOR FRAME MANUFACTURER IN INDIA</h1>
                            ...
                            <div className="flex h-full flex-col">
                                ...
                                <div className="mb-2">
                                    <div className="inline-flex items-baseline gap-3">
                                        <h2 className="text-2xl font-semibold tracking-wide bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">Saburi Smart WPC Door Frames</h2>
                ...
                <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
                    <div className="text-center mb-8 lg:mb-12">
                        ...
                        <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
                            Find answers to common questions about Saburi Smart WPC Door Frames
                        </p>
                    </div>
