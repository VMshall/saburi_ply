...
export default function SaburiModwudPlain() {
    const images = [
        {
            id: 1,
            src: "/images/chipboard-product/Saburi-Modwud-Plain.webp",
            alt: "Saburi Perennial board full view",
        },
        {
            id: 2,
            src: "/images/chipboard-product/Saburi-Modwud-Plain 2.webp",
    ...
    const premium = `Provides the flexibility of plain, non-laminated boards tailored for OEMs and large-scale furniture manufacturers. Plain chipboards offer complete freedom in finishing — ideal for paint, laminates, veneers, melamine, lacquer films, and PVC/PET/Acrylic films, enabling fully customized surface design.
`;
    ...
    const badges = [
        { id: "density", icon: TbBaselineDensitySmall, title: "High Density", sub: "Available" },
        { id: "stable", icon: Scale, title: "Dimensionally Stable", sub: "Stable" },
        { id: "strength", icon: Dumbbell, title: "High Load-Bearing Capacity", sub: "High" },
        { id: "smooth", icon: Grid2x2, title: "Smooth Surface", sub: "Smooth" },
        { id: "crack", icon: GiCrackedDisc, title: "Crack Resistant", sub: "Seamless" },
    ...
    const faqs = [
        {
            question: "What is Saburi Modwud Plain Chipboard?",
            answer: "Saburi Modwud Plain Chipboard is a lightweight and cost-effective engineered board made from high-quality wood particles that are compressed and bonded for strength and stability. Being 100% calibrated, it offers a smooth and uniform surface that allows complete freedom in finishing. It is an ideal base material for laminates, veneers, paints, and other decorative finishes, making it perfect for furniture manufacturing, interior panels, partitions, and modular furniture where affordability and customization are important."
        },
        {
            question: "Why is Saburi Modwud Plain Chipboard ideal to use?",
            answer: "Saburi Modwud Plain Chipboard is ideal for manufacturing lightweight furniture and OEM production. It works perfectly with laminates or veneers, making it suitable for wardrobes, cabinets, shelves, and panels where strength, smooth finish, and cost efficiency are required."
        },
        {
            question: "Does Saburi Modwud Plain offer good screw-holding capacity?",
            answer: "Yes. Unlike inferior particle boards that crumble, our plain chipboard features a dense, tightly bonded core structure. It provides excellent grip for standard woodworking screws, hinges, and modern modular assembly fittings."
        },
        {
            question: "Is this board an environmentally friendly choice?",
            answer: "Absolutely. Saburi Modwud is manufactured using engineered wood fibers and reclaimed wood particles with E1 low-emission standards, making it a highly eco-friendly and sustainable alternative to solid timber, without compromising on utility for interior woodwork."
        },
        {
            question: "Can I paint or apply laminates directly onto Saburi Modwud Plain?",
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <PageHeader title="Saburi Modwud Plain" trail={[{ name: "Home", to: "/" }, { name: "Products" }]} />

            <section className="py-8 sm:py-12 lg:py-16">
                <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative">
                    <div className="text-center mb-8 lg:mb-12">
                        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary tracking-wide">SABURI MODWUD PLAIN</h1>
                        {/* <div className="mt-3 flex items-center justify-center gap-2">
                            <span className="px-3 py-1 text-xs rounded-full border border-primary/20 bg-primary/5 text-primary">IS: 3087</span>
                            ...
                            <div className="flex h-full flex-col">
                                ...
                                <div className="mb-2">
                                    <div className="inline-flex items-baseline gap-3">
                                        <h2 className="text-2xl font-semibold tracking-wide bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">Saburi Modwud Plain (IS: 3087)</h2>
