...
import { GiDuration, GiUnbalanced } from "react-icons/gi";
...
export default function SaburiNeowud() {
    const images = [
        {
            id: 1,
            src: "/images/neowud-product/neowud1.webp",
            alt: "Saburi Neowud board full view",
        },
        {
            id: 2,
            src: "/images/neowud-product/neowud2.webp",
            alt: "Saburi Neowud board full view",
        },
    ];
    ...
    const badges = [
        ...
        { id: "recyclable", icon: FaRecycle, title: "Recyclable", sub: "High" },
    ...
    const faqs = [
        {
            question: "What is Saburi Neowud made from?",
            answer: "Saburi Neowud is a new-generation panel made from natural fibres and rice husk, designed for modern interiors. It offers durability, moisture and termite resistance, flame retardant properties, and supports seamless curved designs."
        },
        {
            question: "Why rethink conventional materials?",
            answer: "Millions of tons of agricultural husk are burnt every year, causing severe air pollution and health hazards, while forests are cut to meet construction demand. Saburi Neowud offers a sustainable alternative made from recycled natural resources."
        },
        {
            question: "What are the key applications of Saburi Neowud?",
            answer: "Saburi Neowud is ideal for contemporary shutters, designer counters, wall panels, wardrobes, and premium interior furniture where smooth curves, wrapped edges, and seamless profiles are required."
        },
        {
            question: "Can Saburi Neowud be shaped into curved designs?",
            answer: "Yes. With controlled heat forming, Saburi Neowud panels can be molded into smooth curves, wrapped edges, and seamless profiles, making it perfect for modern architectural and furniture designs."
        },
        {
            question: "Is Saburi Neowud safe and environmentally friendly?",
            answer: "Yes. Saburi Neowud is waterproof, termite proof, flame retardant, zero formaldehyde, and low VOC, making it an eco-friendly panel that supports sustainable construction and healthier indoor spaces."
        },
    ];
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <PageHeader title="Saburi Neowud" trail={[{ name: "Home", to: "/" }, { name: "Products" }]} />

            <section className="py-8 sm:py-12 lg:py-16">
                <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative">
                    <div className="text-center mb-8 lg:mb-12">
                        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary tracking-wide">SABURI NEOWUD</h1>
                        {/* <div className="mt-3 flex items-center justify-center gap-2">
                            ...
                            <span className="px-3 py-1 text-xs rounded-full border border-primary/20 bg-primary/5 text-primary">(NRFC) – Natural Reinforced Fibre Composite</span>
                        </div> */}
                        <div className="mt-3 flex items-center justify-center gap-4 text-sm font-semibold text-gray-700 tracking-wider">
                            <span className="flex items-center gap-2">
                                ...
                                (NRFC) – Natural Reinforced Fibre Composite
                            </span>
                        </div>
                    </div>
                            ...
                            <div className="flex h-full flex-col">
                                ...
                                <div className="mb-2">
                                    <div className="inline-flex items-baseline gap-3">
                                        <h2 className="text-2xl font-semibold tracking-wide bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">Saburi Neowud</h2>
