...
export default function SaburiShinePlatinumShuttering() {
  const images = [
    {
      id: 1,
      src: "/images/shuttering-product/Shine-Platinum.webp",
      alt: "Saburi Perennial board full view",
    },
    {
      id: 2,
      src: "/images/shuttering-product/Shuttering 2.webp",
  ...
  const premium = `Saburi Shine Platinum is engineered for heavy-duty concrete formwork applications where 
strength, durability, and reuse value are critical. With thicker face veneers designed to withstand 
concrete loads, vibrations, and extreme weather, it performs reliably across beams, pillars, slab 
frameworks, mezzanine flooring, and truck body work.
Conforming to IS: 4990 standards and backed by extensive research and development, Saburi 
Shine Platinum is the dependable choice for contractors and builders. As a trusted <strong>Shuttering 
Plywood Manufacturer in India</strong>, Saburi Ply delivers consistent quality nationwide.`;
  ...
  const faqs = [
    {
      question: "What is Saburi Shine Platinum primarily used for?",
      answer: "Saburi Shine Platinum is a heavy-duty film-faced densified plywood designed specifically for concrete formwork, construction shuttering, and scaffolding. It is used to cast smooth concrete walls, slabs, and columns."
    },
    {
      question: "How many repetitions (reuses) can I expect from Saburi Shine Platinum?",
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <PageHeader title="Shuttering Plywood Manufacturer in India" trail={[{ name: "Home", to: "/" }, { name: "Products" }]} />

      <section className="py-8 sm:py-12 lg:py-16">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative">
          <div className="text-center mb-8 lg:mb-12">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary tracking-wide">SHUTTERING PLYWOOD MANUFACTURER IN INDIA</h1>
            {/* <div className="mt-3 flex items-center justify-center gap-2">
              <span className="px-3 py-1 text-xs rounded-full border border-primary/20 bg-primary/5 text-primary">IS: 4990</span>
              ...
              <div className="flex h-full flex-col">
                ...
                <div className="mb-2">
                  <div className="inline-flex items-baseline gap-3">
                    <h2 className="text-2xl font-semibold tracking-wide bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">Saburi Shine Platinum (IS: 4990)</h2>
          ...
          <div className="mt-8 bg-white rounded-xl shadow-[0_10px_30px_rgba(2,6,23,0.06)] ring-1 ring-gray-100 overflow-hidden">
            ...
            <div className="px-4 sm:px-6 py-4 bg-gray-50 flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
              <div className="text-sm text-gray-600">Are you in search of the most affordable shuttering plywood price in Kolkata? As trusted shuttering plywood manufacturers in Bengal,<br /> we offer unbeatable prices without compromising on strength and durability. Experience the best value for projects in India today!</div>
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="text-center mb-8 lg:mb-12">
            ...
            <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
              Find answers to common questions about Saburi Shuttering plywood
            </p>
          </div>
