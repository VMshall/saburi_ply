...
import { GiScrew, GiPineTree, GiChemicalDrop } from "react-icons/gi";
import {
    ArrowLeft,
    ArrowRight,
    QrCode,
...
export default function SaburiFRBlockBoard() {
    const images = [
        {
            id: 1,
            src: "/images/blockboard-product/FR.webp",
    ...
    const badges = [
        { id: "hardwood", icon: GiPineTree, title: "Pinewood", sub: "Available" },
        { id: "strength", icon: Dumbbell, title: "Superior Strength", sub: "High" },
        { id: "chemical", icon: GiChemicalDrop, title: "Chemical Preservation", sub: "High" },
        // { id: "balance", icon: Scale, title: "Moisture Balance", sub: "Available" },
        { id: "screw", icon: GiScrew, title: "High Screw Holding", sub: "Available" },
    ];
    ...
    const faqs = [
        {
            question: "How does Saburi FR Blockboard protect against fire hazards?",
            answer: "This blockboard is treated with specialized, advanced fire-retardant chemicals. In a fire emergency, it actively resists ignition, slows down the spread of flames across the surface, and prevents the fire from rapidly penetrating the core."
        },
        {
            question: "Where is it mandatory or highly recommended to use Saburi FR?",
            answer: "It is essential for high-risk areas and public spaces. We highly recommend it for commercial kitchens, electrical panel enclosures, hotel corridors, hospital interiors, and any space where strict fire safety compliance is required."
        },
        {
            question: "Does this board emit dangerous smoke when exposed to fire?",
            answer: "No. Our fire-retardant formulation is specifically designed for low smoke emission and prevents the release of highly toxic gases. This buys crucial time for safe evacuation and reduces smoke-inhalation risks."
        },
        {
            question: "Is Saburi FR Blockboard weaker than regular blockboard due to the chemicals?",
            answer: "Not at all. The chemical impregnation is carefully balanced to ensure that the board retains 100% of its structural integrity, load-bearing capacity, and screw-holding strength."
        },
        {
            question: "Can I apply standard laminates or veneers to the Saburi FR surface?",
            answer: "Yes. The board is perfectly calibrated and sanded to a smooth finish, allowing you to easily apply any decorative laminate, veneer, or paint without compromising its fire-retardant capabilities."
        },
    ];
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <PageHeader title="Saburi FR Block Board" trail={[{ name: "Home", to: "/" }, { name: "Products" }]} />

            <section className="py-8 sm:py-12 lg:py-16">
                <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative">
                    <div className="text-center mb-8 lg:mb-12">
                        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary tracking-wide">SABURI FR BLOCK BOARD</h1>
                            ...
                            <div className="flex h-full flex-col">
                                ...
                                <div className="mb-2">
                                    <div className="inline-flex items-baseline gap-3">
                                        <h2 className="text-2xl font-semibold tracking-wide bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">Saburi FR Block Board (IS: 1659)</h2>
