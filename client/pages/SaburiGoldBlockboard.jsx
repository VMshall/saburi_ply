...
export default function SaburiGoldBlockboard() {
    const images = [
        {
            id: 1,
            src: "/images/blockboard-product/Gold.webp",
            alt: "Saburi Gold Blockboard full view",
        },
    ];
    ...
    const premium = `Only selected species of timber used, and Prophylactic treatment by impregnating with concentrated preservative solution of insecticide and fungicide for long lasting protection It is kiln- seasoned to less than 8 -10% moisture content for proper bonding. Saburi Gold 710 Block Board offers  high dimensional stability, high mechanical properties, excellent screw holding capacity, and does not expand, contract or warp like solid wood. It can be used for both internal and external areas.

As a prominent block board manufacturer in Bengal, Saburi Ply is recognised for its commitment to produce high-quality and long- lasting products. We are dependable, trusted and reliable suppliers of block board suppliers in Kolkata and throughout the nation, offering best for both interior and exterior applications`;
    ...
    const thickness = ["19mm", "25mm"];
    const sizes = ["10x4 ft.", "8x4 ft.", "7x4 ft."];

    const badges = [
        { id: "pinewood", icon: TreePine, title: "100% Pinewood", sub: "Available" },
        { id: "strength", icon: Dumbbell, title: "Strength", sub: "High" },
        { id: "screw", icon: GiScrew, title: "Screw Holding ", sub: "Available" },
        { id: "Antifungal", icon: FaBacteria, title: "Prophylactic treatment", sub: "High" },
    ];
    ...
    const faqs = [
        {
            question: "Is Saburi Gold Blockboard suitable for wet areas?",
            answer: "Saburi Gold is bonded with un-extended BWP (Boiling Water Proof) grade synthetic resins. This gives it exceptional resistance to water and high humidity, making it the ideal blockboard for areas prone to moisture."
        },
        {
            question: "What furniture is best built using Saburi Gold?",
            answer: "It is the ultimate choice for modular kitchen cabinets, bathroom vanities, utility room storage, and dining area furniture where water spills or steam are common daily occurrences."
        },
        {
            question: "How does Saburi Gold compare to commercial MR-grade blockboards?",
            answer: "Unlike standard MR (Moisture Resistant) boards, Saburi Gold’s BWP bonding means it will not delaminate or swell even if exposed to continuous dampness, offering a much higher return on investment for high-moisture zones."
        },
        {
            question: "Will heavy kitchen hardware loosen over time with this board?",
            answer: "No. The high-density timber core provides exceptional nail and screw-holding strength. Heavy kitchen channels, pull-out pantry hardware, and hydraulic hinges will remain firmly in place without sagging."
        },
        {
            question: "Is it safe from the pests commonly found in damp kitchen environments?",
            answer: "Yes. Alongside its waterproof properties, Saburi Gold is fortified with highly effective, eco-friendly preservatives that completely repel termites, borers, and decay-causing fungi."
        },
    ];
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <PageHeader title="Saburi Gold Blockboard" trail={[{ name: "Home", to: "/" }, { name: "Products" }]} />

            <section className="py-8 sm:py-12 lg:py-16">
                <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative">
                    <div className="text-center mb-8 lg:mb-12">
                        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary tracking-wide">SABURI GOLD BLOCKBOARD</h1>
                            ...
                            <div className="flex h-full flex-col">
                                ...
                                <div className="mb-2">
                                    <div className="inline-flex items-baseline gap-3">
                                        <h2 className="text-2xl font-semibold tracking-wide bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">Saburi Gold Blockboard (IS: 710)</h2>
