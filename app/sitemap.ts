...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    entry("/plywood-guide", 0.7, "monthly"),
    entry("/plywood-guide/is-standards", 0.7, "monthly"),
    entry("/plywood-guide/waterproof-grades", 0.7, "monthly"),
    entry("/plywood-guide/fire-safety", 0.7, "monthly"),
    entry("/plywood-guide/emissions-safety", 0.7, "monthly"),
    entry("/plywood-guide/manufacturing-process", 0.7, "monthly"),
    entry("/plywood-guide/material-properties", 0.7, "monthly"),
    entry("/plywood-buying-guide", 0.8, "monthly"),
    entry("/plywood-buying-guide/how-to-buy", 0.7, "monthly"),
    entry("/plywood-buying-guide/pricing-and-warranty", 0.7, "monthly"),
    entry("/plywood-buying-guide/how-much-plywood", 0.7, "monthly"),
    entry("/plywood-buying-guide/which-plywood-home", 0.7, "monthly"),
    entry("/plywood-buying-guide/which-plywood-project", 0.7, "monthly"),
