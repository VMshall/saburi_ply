 ...
 *
 * Server shell only: it owns metadata and the H1, and hands the listing to the BlogIndex island
 * (category filter + search). Cards are passed as BlogCardPost — the article HTML never crosses
 * the client boundary.
 *
 * Deliberately has NO PageHeader banner: the section is content-first, so the listing starts right
 * under the breadcrumb strip and the featured card carries the page. Every other content route
 * still uses the photo banner.
 */
