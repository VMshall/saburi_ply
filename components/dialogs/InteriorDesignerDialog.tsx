...
export function InteriorDesignerDialog({ open, onOpenChange }) {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            router.push(
                `/thank-you?title=${encodeURIComponent("Thank you — we received your Interior Designer request.")}&message=${encodeURIComponent("Our team will contact you shortly.")}&buttonText=${encodeURIComponent("Submit Another Request")}&returnUrl=${encodeURIComponent("/")}`
            );
