...
export function DealershipDialog({
  ...
  async function handleDealerSubmit(e) {
    ...
    try {
      ...
      router.push(
        `/thank-you?title=${encodeURIComponent("Thank you — we received your dealership request.")}&message=${encodeURIComponent("Our team will contact you shortly.")}&buttonText=${encodeURIComponent("Submit Another Request")}&returnUrl=${encodeURIComponent("/")}`
      );
